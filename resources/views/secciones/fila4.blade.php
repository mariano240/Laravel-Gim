        ...
        <div class="col-md-4">
            <div class="card card-product">
                ...
                <div class="card-body">
                    ...
                    <div class="card-description">
                        The place is close to Metro Station and bus stop just 2 min by walk and
                        near to "Naviglio" where you can enjoy the night life in London, UK.
                    </div>
                </div>
                <div class="card-footer">
                    <div class="price">
        ...
        <div class="col-md-4">
            <div class="card card-product">
                ...
                <div class="card-body">
                    ...
                    <div class="card-description">
                        The place is close to Metro Station and bus stop just 2 min by walk and
                        near to "Naviglio" where you can enjoy the main night life in Milan.
                    </div>
                </div>
                <div class="card-footer">
                    <div class="price">
